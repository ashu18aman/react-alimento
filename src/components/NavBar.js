				...
				<Toolbar>
					...
					<div className={classes.header}>
						<List className={classes.headerList}>
							...
							<ListItem>
								<Link to="/" className={classes.headerLinksText}>Menu</Link>
							</ListItem>
						</List>
					</div>
					...
					<List className={classes.navList}>
						...
						<ListItem>
							<Button variant="outlined" className={classes.navLinks}>
								<Link to="/" className={classes.navLinksText}>SignUp</Link>
							</Button>
						</ListItem>
						<ListItem>
								<Button variant="contained">
									<Link to="/" className={classes.navLinksText}>Login</Link>
								</Button>
						</ListItem>
					</List>
